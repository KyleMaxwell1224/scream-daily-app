          ...
          {top3.map((row, i) => {
            ...
            return (
              <div key={row.user_id} style={{
                ...
                background: isMe
                  ? 'linear-gradient(135deg, rgba(192,21,42,0.18) 0%, rgba(24,15,15,0.95) 100%)'
                  : `linear-gradient(135deg, ${p.bg} 0%, rgba(24,15,15,0.95) 100%)`,
              ...
              {rest.map((row, i) => {
                ...
                return (
                  <div key={row.user_id} style={{
                    ...
                    background: isMe
                      ? 'linear-gradient(135deg, rgba(192,21,42,0.12) 0%, rgba(24,15,15,0.9) 100%)'
                      : 'linear-gradient(135deg, rgba(192,21,42,0.05) 0%, rgba(24,15,15,0.9) 100%)',
